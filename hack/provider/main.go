...
var checksumMap = map[string]string{
	"./release/devpod-provider-opentelekomcloud-linux-amd64":       "##CHECKSUM_LINUX_AMD64##",
	"./release/devpod-provider-opentelekomcloud-linux-arm64":       "##CHECKSUM_LINUX_ARM64##",
	"./release/devpod-provider-opentelekomcloud-darwin-amd64":      "##CHECKSUM_DARWIN_AMD64##",
	"./release/devpod-provider-opentelekomcloud-darwin-arm64":      "##CHECKSUM_DARWIN_ARM64##",
	"./release/devpod-provider-opentelekomcloud-windows-amd64.exe": "##CHECKSUM_WINDOWS_AMD64##",
}
